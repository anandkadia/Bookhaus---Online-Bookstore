						...
						<form class="form-horizontal search-form" action="AdvanceSearch">
							...
							<div class="row">
								<div class="col-sm-4 filter-box">
									...
									<div class="form-group">
										<label for="genre" class="control-label">Sort By</label>
										<div>
											<select class="form-control" name="sortBy"
												...
												<option value="published_date desc">Year -
													Descending</option>
									...
									<div class="form-group">
										<label for="genre" class="control-label">Subject</label>
										<div>
											<div class="radio">
								...
								<div class="col-sm-4 filter-box">
									...
									<div class="form-group">
										...
										<div>
											...
											<div class="radio">
												<label> <input type="radio" name="genre" value="pop">
													Pop
												</label>
											</div>
											<div class="radio">
